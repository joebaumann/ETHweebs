...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default=defaults.pretrained_model_name_or_path,
    ...
    parser.add_argument(
        "--instance_data_dir",
        type=str,
        default=defaults.instance_data_dir,
    ...
    parser.add_argument(
        "--instance_prompt",
        type=str,
        default=defaults.instance_prompt,
    ...
    parser.add_argument(
        "--validation_prompt",
        type=str,
        default=defaults.validation_prompt,
    ...
    parser.add_argument(
        "--train_batch_size", type=int, default=defaults.train_batch_size,
    ...
    parser.add_argument(
        "--checkpointing_steps",
        type=int,
        default=defaults.checkpointing_steps,
        help=(
